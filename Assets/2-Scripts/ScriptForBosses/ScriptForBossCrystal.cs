...
public class ScriptForBossCrystal : MonoBehaviour
{
    ...
    [SerializeField] private GameObject greenArmor; 
    [SerializeField] private GameObject manticoreSword; 
    ...
    private void Die()
    {
        if (!isDying)
        {
            ...
            healthPotionPrefab.transform.position = new Vector3(84f, -5.5f, transform.position.z);
            greenArmor.SetActive(true);
            greenArmor.transform.position = new Vector3(84.79f, -5.5f, transform.position.z);
            manticoreSword.SetActive(true);
            manticoreSword.transform.position = new Vector3(85.63f, -5.5f, transform.position.z);
    ...
    private void ShowPortal()
    {
        if (portalPrefab)
        {
            ...
            portalPrefab.transform.position = new Vector3(87.0f, -4.5f, transform.position.z);
