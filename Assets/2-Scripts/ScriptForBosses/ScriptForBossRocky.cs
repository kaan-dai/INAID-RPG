...
public class ScriptForBossRocky : MonoBehaviour
{
    ...
    [SerializeField] private GameObject blackArmor; 
    [SerializeField] private GameObject sharpenedSword;
    ...
    private void Die()
    {
        if (!isDying)
        {
            ...
            blackArmor.SetActive(true);
            sharpenedSword.SetActive(true);
            ShowPortal();
