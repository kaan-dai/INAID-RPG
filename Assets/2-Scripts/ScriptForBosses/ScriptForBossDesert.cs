...
public class ScriptForBossDesert : MonoBehaviour
{
   [SerializeField] private float moveSpeed = 1f;
    ...
    [SerializeField] private GameObject redArmor; 
    [SerializeField] private GameObject warHammer;
